 ...
 * GitHub: 		https://github.com/DavidDiPaola
 * Project URL: https://github.com/DavidDiPaola/avr-libs/tree/master/spi
 *
 * Modified to work with ATmega 2560
 */
...
void spi_init(uint8_t lsbfirst,
  ...
  // Set low for SCK and MOSI and high for SS
  __SPI_PORT &= ~(1<<__SPI_SCK);
  __SPI_PORT &= ~(1<<__SPI_MOSI);
  __SPI_PORT |= (1<<__SPI_SS);
